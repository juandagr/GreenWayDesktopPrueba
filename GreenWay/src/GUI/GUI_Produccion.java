...
public class GUI_Produccion extends javax.swing.JFrame {
    ...
    //Constructor
    public GUI_Produccion(Gui_InfoLotes gui_infoLotes) {
        initComponents();
        ...
        modeloItems.addColumn("Selecta");
        modeloItems.addColumn("Corriente");
        modeloItems.addColumn("Industrial");
    ...
    public void buscarProducciones(){
        ...
        ArrayList<Produccion> producciones = new ControladorProduccion().consultarProduccionxLote(loteID);
        ...
        for (int i = 0; i < producciones.size(); i++) {
            ...
            fila[0] = producciones.get(i).getLote_identificador();
            fila[1] = producciones.get(i).getAnio();
            fila[2] = producciones.get(i).getSemana();
            fila[3] = producciones.get(i).getDia();
            fila[4] = producciones.get(i).getSelecta();
            fila[5] = producciones.get(i).getCorriente();
            fila[6] = producciones.get(i).getIndustrial();
    ...
    private void jButtonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAgregarActionPerformed
        ...
        Gui_AgregarProduccion gui_agregarProduccion = new Gui_AgregarProduccion(this);
    
        gui_agregarProduccion.setVisible(true);
    ...
    private void jButtonAgregar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAgregar1ActionPerformed
        ...
        try{
            ...
            if (this.obtenerIdentificacionSeleccionado().equalsIgnoreCase("No selecciono") == false) {
                ...
                Gui_ModificarProduccion modificar = new Gui_ModificarProduccion(this, loteId, anio, semana, dia);
                modificar.setVisible(true);

                this.dispose();
            }else{
                JOptionPane.showMessageDialog(null, "Seleccione un registro de produccion para modificar", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, "Seleccione un registro de produccion para modificar", "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_Produccion(null).setVisible(true);
            }
        });
    }
