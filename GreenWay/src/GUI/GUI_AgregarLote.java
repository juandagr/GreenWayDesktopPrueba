...
public class GUI_AgregarLote extends javax.swing.JFrame {
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(jButtonAgregarLote)
    ...
    private void jButtonAgregarLoteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAgregarLoteActionPerformed
        try{
            ...
            double costo_por_hora = Double.parseDouble(jTextFieldCosto.getText().trim());;
    ...
    //metodo encargado de verificar que los campos obligatorios para crear un empleado
     ...
     public boolean verificarCamposVacios(){
         ...
         if (jTextFieldArea.getText().equalsIgnoreCase("") || jTextFieldCosto.getText().equalsIgnoreCase("") ||
